...
FuzzyRule *regra3_2 = new FuzzyRule(1, regras3_2, saida_regra3_2);
fuzzy->addFuzzyRule(regra3_2);
...
FuzzyRule *regra3_3 = new FuzzyRule(12, regras3_3, saida_regra3_3);
fuzzy->addFuzzyRule(regra3_3);
...
FuzzyRule *regra4_1 = new FuzzyRule(3, regras4_1, saida_regra4_1);
fuzzy->addFuzzyRule(regra4_1);
...
FuzzyRule *regra4_2 = new FuzzyRule(4, regras4_2, saida_regra4_2);
fuzzy->addFuzzyRule(regra4_2);
...
FuzzyRule *regra4_3 = new FuzzyRule(5, regras4_3, saida_regra4_3);
fuzzy->addFuzzyRule(regra4_3);
...
FuzzyRule *regra5_1 = new FuzzyRule(6, regras5_1_antecedente, regras5_1_consequente);
...
FuzzyRule *regra5_2 = new FuzzyRule(7, regras5_2_antecedente, regras5_2_consequente);
...
FuzzyRule *regra5_3 = new FuzzyRule(8, regras5_3_antecedente, regras5_3_consequente);
...
FuzzyRule *regra6_1 = new FuzzyRule(9, regras6_1_antecedente, regras6_1_consequente);
...
FuzzyRule *regra6_2 = new FuzzyRule(10, regras6_2_antecedente, regras6_2_consequente);
...
FuzzyRule *regra7_1 = new FuzzyRule(11, regras7_1_antecedente, regras7_1_consequente);
...
FuzzyRule *regra7_2 = new FuzzyRule(12, regras7_2_antecedente, regras7_2_consequente);

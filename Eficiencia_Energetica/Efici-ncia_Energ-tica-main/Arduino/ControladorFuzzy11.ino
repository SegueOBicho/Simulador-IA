...
FuzzyRule *regra6_1 = new FuzzyRule(21, regras6_1_antecedente, regras6_1_consequente);
...
FuzzyRule *regra6_2 = new FuzzyRule(22, regras6_2_antecedente, regras6_2_consequente);
...
FuzzyRule *regra6_3 = new FuzzyRule(23, regras6_3_antecedente, regras6_3_consequente);
...
FuzzyRule *regra7_1 = new FuzzyRule(24, regras7_1_antecedente, regras7_1_consequente);
...
FuzzyRule *regra7_2 = new FuzzyRule(25, regras7_2_antecedente, regras7_2_consequente);
...
void loop() {
  ...
  Serial.print(",");
  Serial.print(fuzzy->isFiredRule(21)); //6_1
  Serial.print(",");
  Serial.print(fuzzy->isFiredRule(22)); //6_2
  Serial.print(",");
  Serial.print(fuzzy->isFiredRule(23)); //6_3
  Serial.print(",");
  Serial.print(fuzzy->isFiredRule(24)); //7_1
  Serial.print(",");
  Serial.print(fuzzy->isFiredRule(25)); //7_2
  Serial.print(",");
  Serial.print(input1);
  Serial.print(",");
  Serial.print(input2);
